...
class GridWorldEnvA(GridWorldEnv):
    """docstring for GridWorldEnvA"""
    def __init__(self):
        super(GridWorldEnvA, self).__init__()
        self.goal_position = (11, 11)
        
class GridWorldEnvB(GridWorldEnv):
    """docstring for GridWorldEnvB"""
    def __init__(self):
        super(GridWorldEnvB, self).__init__()
        self.goal_position = (9, 9)
        
class GridWorldEnvC(GridWorldEnv):
    """docstring for GridWorldEnvC"""
    def __init__(self):
